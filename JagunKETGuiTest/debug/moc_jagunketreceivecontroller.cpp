...
static const char qt_meta_stringdata_JagunKETReceiveController[] = {
    ...
    "warning\0warning(EWJagunKETReceiveController)\0"
    "failure()\0"
};
...
int JagunKETReceiveController::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: warning((*reinterpret_cast< EWJagunKETReceiveController(*)>(_a[1]))); break;
...
// SIGNAL 2
void JagunKETReceiveController::warning(EWJagunKETReceiveController _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
